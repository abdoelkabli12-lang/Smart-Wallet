  ...
  <header class="relative">
    ...
    <div class="absolute right-20 flex gap-1 items-center">
      <p class=" text-white ml-auto mr-4 font-semibold">
        ...
        <a href="login.php"><button id="user" class="absolute w-5 h-12  right-5"><svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M144 128a80 80 0 1 1 160 0 80 80 0 1 1 -160 0zm208 0a128 128 0 1 0 -256 0 128 128 0 1 0 256 0zM48 480c0-70.7 57.3-128 128-128l96 0c70.7 0 128 57.3 128 128l0 8c0 13.3 10.7 24 24 24s24-10.7 24-24l0-8c0-97.2-78.8-176-176-176l-96 0C78.8 304 0 382.8 0 480l0 8c0 13.3 10.7 24 24 24s24-10.7 24-24l0-8z"/></svg>
      </button></a>
          <button id="logout-btn" class="absolute right-[22rem] text-white font-extrabold">
      Logout
    </button>
...
<div id="logout-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center">
  ...
  <div class="cont relative w-full max-w-sm rounded-2xl bg-white shadow-xl p-6 animate-fadeIn">
    ...
    <div class="flex gap-4">
      ...
      <form action="logout.php" method="post" class="w-1/2">
